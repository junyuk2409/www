...
?>
			...
			<div id="list_item">
			    <ul>
			        <li id="list_item1"><a href="view.php?table=<?=$table?>&num=<?=$item_num?>&page=<?=$page?>"><img src="<?=$item_img?>" alt="" width="260" height="170" class="thumbnail"></a></li>
                    <li id="list_item2"><a href="view.php?table=<?=$table?>&num=<?=$item_num?>&page=<?=$page?>"><?= $item_subject ?></a></li>
			        <li id="list_item3"><a href="view.php?table=<?=$table?>&num=<?=$item_num?>&page=<?=$page?>"><?= $item_content ?></a></li>
